...
ActiveRecord::Schema[7.1].define(version: 9025_08_19_224903) do
  ...
  create_table "account_features", id: :uuid, default: nil, force: :cascade do |t|
    t.uuid "account_id", null: false
  ...
  create_table "account_plans", id: :uuid, default: nil, force: :cascade do |t|
    t.uuid "account_id", null: false
  ...
  add_foreign_key "account_features", "accounts", name: "account_features_account_id_fkey"
  add_foreign_key "account_features", "features", name: "account_features_feature_id_fkey"
  add_foreign_key "account_plans", "accounts", name: "account_plans_account_id_fkey"
  add_foreign_key "account_plans", "plans", name: "account_plans_plan_id_fkey"
