class Api::V1::Accounts::DataPrivacyController < Api::V1::Accounts::BaseController
  before_action :check_authorization

  before_action :authenticate_user!
  before_action :set_privacy_service

  # GET /api/v1/accounts/:account_id/data_privacy/dashboard
  def dashboard
  ...
  # GET /api/v1/accounts/:account_id/data_privacy/consents
  def consents
  ...
  # POST /api/v1/accounts/:account_id/data_privacy/consents
  def grant_consent
    ...
    success_response(
      data: {
        consent: DataPrivacyConsentSerializer.basic(consent)
      },
      message: 'Consent granted successfully'
    )
  end

  # DELETE /api/v1/accounts/:account_id/data_privacy/consents/:consent_type
  def revoke_consent
    consent_type = params[:consent_type]
  ...
  # GET /api/v1/accounts/:account_id/data_privacy/export
  def export_data
  ...
  # GET /api/v1/accounts/:account_id/data_privacy/portability
  ...
  # POST /api/v1/accounts/:account_id/data_privacy/deletion_request
      ...
      success_response(
        data: {
          ...
          instructions: {
            ...
            confirmation_endpoint: '/api/v1/accounts/:account_id/data_privacy/confirm_deletion',
            expires_in: '7 days',
  ...
  # POST /api/v1/accounts/:account_id/data_privacy/confirm_deletion
    ...
    [
      {
        ...
        endpoint: 'GET /data_privacy/export'
      },
      {
        action: 'manage_consents',
        title: 'Manage Consents',
        description: 'Review and update your privacy preferences',
        endpoint: 'GET /data_privacy/consents'
      },
      {
        action: 'request_deletion',
        title: 'Delete My Account',
        description: 'Permanently delete your account and all data',
        endpoint: 'POST /data_privacy/deletion_request'
      }
    ]
  end

  def check_authorization
    # Verificar se usuário tem permissão para gerenciar data privacy
    action_map = {
